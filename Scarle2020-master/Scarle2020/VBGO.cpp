...
void VBGO::Init(ID3D11Device* _GD)
{
	...
	HRESULT hr = CompileShaderFromFile(L"../Models/shader.fx", "VS", "vs_4_0_level_9_1", &pVertexShaderBuffer);
	_GD->CreateVertexShader(pVertexShaderBuffer->GetBufferPointer(), pVertexShaderBuffer->GetBufferSize(), NULL, &s_pVertexShader);

	//default pixelshader
	ID3DBlob* pPixelShaderBuffer = NULL;
	hr = CompileShaderFromFile(L"../Models/shader.fx", "PS", "ps_4_0_level_9_1", &pPixelShaderBuffer);
	...
	//default texture (white square)
	hr = CreateDDSTextureFromFile(_GD, L"../Models/white.dds", nullptr, &s_pTextureRV);
